...
/* USER CODE BEGIN PFP */
void HAL_UARTEx_RxEventCallback(UART_HandleTypeDef *huart,uint8_t Size);
/* USER CODE END PFP */
...
void USART1_IRQHandler(void)
{
  /* USER CODE BEGIN USART1_IRQn 0 */
        ...
        __HAL_UART_GET_IT_SOURCE(&huart1, UART_IT_IDLE))
    {
        ...
        uint16_t received = Rx_Buff_Size - remaining;

        HAL_UARTEx_RxEventCallback(&huart1, received);
    }
